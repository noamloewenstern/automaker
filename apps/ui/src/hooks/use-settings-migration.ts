...
export function hydrateStoreFromSettings(settings: GlobalSettings): void {
  ...
  useAppStore.setState({
    ...
    claudeCodeExecutablePath: settings.claudeCodeExecutablePath ?? undefined,
    claudeCodeExtraArgs: settings.claudeCodeExtraArgs ?? undefined,
    claudeCodeEnvVars: settings.claudeCodeEnvVars ?? undefined,
    defaultMaxTurns: settings.defaultMaxTurns ?? undefined,
